                                ...
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-12">
                                        <Form.Group className="mb-4">
                                            ...
                                            <input id="title" type="text" placeholder="Your NFT name" onChange={(e) =>
                                    ...
                                    <div className="col-12">
                                        <Form.Group className="mb-4">
                                            ...
                                            <textarea id="description" as="textarea" placeholder="Write short description" onChange={(e) =>
                                    ...
                                    <div className="col-12 col-md-6">
                                        <Form.Group className="mb-4">
                                            ...
                                            <input id="price" type="text" placeholder="0.324 ETH" onChange={(e) =>
                                    ...
                                    <div className="col-12 col-md-4">
                                        <button className="btn btn-primary rounded-pill w-100"  onClick={listNFTForSale}>
                                            Create
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div className="nft-card card shadow-sm">
                            <div className="card-body">
                                <div className="img-wrap">
                                    {fileUrl ? (<img src={fileUrl} alt="nft" />)
                                        : <img src="https://funto.designing-world.com/img/bg-img/17.jpg" alt="" />}
