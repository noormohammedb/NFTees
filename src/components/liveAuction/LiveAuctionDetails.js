...
const LiveAuctionDetails = () => {
    ...
    var nftData = nfts.filter( element => element.tokenId == bidID)
    var nftdata = nftData[0];
    console.log(nftdata)
                ...
                <div className="card-body">
                    <div className="img-wrap">
                        ...
                        <div className={`badge bg-dark position-absolute section-`} >
                            {/* <img src={`${process.env.PUBLIC_URL}/${elem.badgeInfo[0].icon}`} alt={elem.name} /> */}
                            New Bid
                        </div>
                    ...
                    <div className="row gx-2 align-items-center mt-2">
                        ...
                        <div className="col-4">
                            <div className="price text-end">
                                <span className="fz-12 d-block">Place Bid</span>
                            ...
                            <div className="item-details-content mt-5 mt-lg-0">
                                ...
                                <div className="d-flex align-items-center mb-4">
                                    ...
                                    <div className="author-img position-relative me-3">
                                        <img 
                                            className="shadow" 
                                            src={nftdata.authorAvater} 
                                            alt={nftdata.seller} 
                                        />
                                        <i className={`bi bi-check position-absolute bg-primary true`} />
                                    </div>
                                ...
                                <div className="row align-items-end">
                                    ...
                                    <div className="col-6 col-sm-4 col-lg-5">
                                        <Link className={`btn btn-primary rounded-pill w-100`} to="#" >
                                            {/* <img 
                                                className="me-1" 
                                ...
                                <div className="short-description">
                                    <h5>{nf.name}</h5>
                                    <p className="mb-0" dangerouslySetInnerHTML={{__html: nftdata.description}} >
                                    </p>
                                </div>
                            </div>
                        </div>
